...
module.exports = {
  ...
  QRCODE_MODEL3: Buffer.from([
    0x1d, 0x28, 0x6b, 0x04, 0x00, 0x31, 0x41, 0x33, 0x00,
  ]), // Model 3
  ...
  QRCODE_CELLSIZE_1: Buffer.from([
    0x1d, 0x28, 0x6b, 0x03, 0x00, 0x31, 0x43, 0x01,
  ]), // Cell size 1
  QRCODE_CELLSIZE_2: Buffer.from([
    0x1d, 0x28, 0x6b, 0x03, 0x00, 0x31, 0x43, 0x02,
  ]), // Cell size 2
  ...
  PDF417_CORRECTION: Buffer.from([
    0x1d, 0x28, 0x6b, 0x04, 0x00, 0x30, 0x45, 0x31,
  ...
  PDF417_OPTION_STANDARD: Buffer.from([
    0x1d, 0x28, 0x6b, 0x03, 0x00, 0x30, 0x46, 0x00,
  ]), // Standard barcode
  PDF417_OPTION_TRUNCATED: Buffer.from([
    0x1d, 0x28, 0x6b, 0x03, 0x00, 0x30, 0x46, 0x01,
  ]), // Truncated barcode
